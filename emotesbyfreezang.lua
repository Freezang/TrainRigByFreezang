...
Grid.CellSize = UDim2.new(0.1, 0, 0.17, 0) -- Taille ajustée pour plus d'emotes par ligne
Grid.CellPadding = UDim2.new(0.005, 0, -0.04, 0) -- Espacement ajusté
...
CreditText.Text = "| by Freezang |" -- Texte à afficher
